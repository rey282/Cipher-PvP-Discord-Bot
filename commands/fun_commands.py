...
class FunCommands(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        if isinstance(error, commands.CommandOnCooldown):
            ...
            await ctx.send("<:Unamurice:1349309283669377064> Oh no… something’s gone awry. I’m terribly sorry. Perhaps… try again later? I’ll be right here when you’re ready.")
