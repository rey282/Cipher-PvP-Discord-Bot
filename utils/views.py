...
class UpdateEloView(ui.View):
    ...
    async def submit(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Apply ELO changes
        winner_elo_changes = distribute_team_elo_change(winner_team, per_player_gain, self.elo_data, scores=winner_scores, gain=True)
        loser_elo_changes = distribute_team_elo_change(loser_team, per_player_loss, self.elo_data, scores=loser_scores, gain=False)
